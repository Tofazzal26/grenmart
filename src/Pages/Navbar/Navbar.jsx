      ...
      <div className="grid grid-cols-4">
        <div className="col-span-1">
          <details className="dropdown">
            <summary className="bg-[#00b106] flex items-center justify-between text-lg cursor-pointer font-semibold gap-[50px] px-12 text-white py-3 rounded-full">
              <IoMdMenu size={22} /> All Categories <BiDownArrow size={21} />
            </summary>
            <ul className="p-2 shadow menu dropdown-content space-y-2 z-[1] text-[#767676] w-[350px] text-[17px] font-Source3 rounded-box bg-[#f8f9fa]">
